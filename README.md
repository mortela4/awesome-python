...
- [Awesome Python](#awesome-python)
    ...
    - [Web Frontend-dev](#web-frontend-dev)
    - [WebSocket](#websocket)
...
* Framework agnostic
    ...
    * [FastAPI Voyager](https://github.com/allmonday/fastapi-voyager) - Visualize FastAPI endpoints.
...
* GUI / Web Testing
    ...
    * [Helium](https://github.com/mherrmann/helium) - Simply a better Selenium ... (?)
